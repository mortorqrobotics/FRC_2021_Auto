...
public class Firstbezierpath {
    ...
    public void FirstInit(Drivetrain drive, Trajectory trajectory){
        ...
        drive.resetOdometry(new Pose2d(new Translation2d(4.0, 6.86), Rotation2d.fromDegrees(0)));
    ...
    public double GetDegree(Drivetrain drive, double distance) {
        ...
        switch (state) {
            ...
            case FOURTH_EQUATION:
                ...
                slope = -BezierDerivative.derive(fourthEquation.funcX, fourthEquation.funcY, t);
                angle =  Convert.getDegrees(slope, 1);
                break;
            case FIFTH_EQUATION:
                ...
                slope = -BezierDerivative.derive(fifthEquation.funcX, fifthEquation.funcY, t);
                angle =  Convert.getDegrees(slope, 1);
                break;
            case SIXTH_EQUATION:
                ...
                slope = -BezierDerivative.derive(sixthEquation.funcX, sixthEquation.funcY, t);
                angle =  Convert.getDegrees(slope, 1);
                break;
            case SEVENTH_EQUATION:
                ...
                slope = -BezierDerivative.derive(seventhEquation.funcX, thirdEquation.funcY, t);
                angle =  Convert.getDegrees(slope, 1);
                break;
            default:
                stopMoving = true;
